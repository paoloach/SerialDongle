...
#define LED1_INIT()	 		  P1SEL &= 0x0FA; P1DIR |= 4;
#define HAL_TURN_ON_LED1()    P1_2 = 1;
#define HAL_TURN_OFF_LED1()   P1_2 = 0;
#define HAL_TOGGLE_LED1()     if (P1_2){P1_2=0;}else {P1_2=1;}

#define LED2_INIT()			  P1SEL &= 0x0F7; P1DIR |= 8;
#define HAL_TURN_ON_LED2()    P1_3 = 0;
#define HAL_TURN_OFF_LED2()   P1_3 = 1;
#define HAL_TOGGLE_LED2()     if (P1_3){P1_3=0;}else {P1_3=1;}
